...
| Obstacle GIF visualization | `shortstop/calvin_obstacle_viz.py` | ✅ **cũng đã generic** — chỉ nhận `trajectory` (list of sphere_centers) + `obstacle`, không biết gì về CALVIN | Dùng thẳng được. |
